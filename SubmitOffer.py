...
API_URL = "https://ms-api-gateway-qa.azurewebsites.net/offers/v1/offers/submit"

# Define the payload (data to be sent in the POST request)
# The exact structure depends on the API's requirements.
# This is a generic example; adjust the keys and values as needed.
payload = {
    "offerID": 2054126,
    "status": "LoadedToCampaign",
    "dateTimeCreated": "2025-12-05T07:08:42.853Z",
    "dateTimeUpdated": "2025-12-05T07:10:54.401Z",
    "countryCode": "BG",
...
def create_offer(API_URL, data, headers_data):
    """
    Sends a POST request to the specified URL with JSON data and headers.
    """
    print(f"Attempting to POST data to: {API_URL}")
    try:
        response = requests.post(API_URL, json=data, headers=headers_data)
...
if __name__ == "__main__":
    create_offer(API_URL, payload, headers)
